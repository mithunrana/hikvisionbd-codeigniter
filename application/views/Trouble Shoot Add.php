        ...
        <div class="container com-sm-7">
            <div class="panel-group">
                 <div class="panel panel-primary">
                    <div class="panel-heading"><h3>Trouble Shooting Add Here</h3></div>
                        <div class="panel-body">
                            ...
                            <div class="container col-sm-6">
                                ...
                                ?>
                                <form action="<?php echo base_url() ?>Super_admin/TroubleShootUpload" method="POST">
                                    <div class="form-group">
                                      <label for="email">Trouble Shoot Name:</label>
                                      <input type="text" class="form-control" id="troubleShootingName" placeholder="Enter Trouble Shoot Name" name="troubleShootingName">
                                    </div>
                                    <div class="form-group">
                                        <label for="Working-Step">Trouble Shoot Working Step:</label>
                                        <textarea name="WorkingStep" class="form-control" rows="5" id="Working-Step"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="comment">Youtube Embedded URL:</label>
                                        <textarea name="YoutubeVideo" class="form-control" rows="4" id="comment"></textarea>
                                    </div>
                            ...
                            <div class="container col-sm-6" style="overflow:scroll">
                                ...
                                <form method="POST" style="overflow:scroll; max-height:400px" action="">
                                    ...
                                    <tbody>
                                        <?php
                                            $sl = 0;
                                            foreach ($TroubleShootList as $d){
                                            ++$sl;
                                            echo "<tr>
                                            <td>$sl</td>
                                            <td>$d->Trouble_Shoot_Name</td>
                    ...
                    <div class="panel-footer">Trouble Shooting Add Here</div>
                </div>
            </div>
        </div>
    </div>
