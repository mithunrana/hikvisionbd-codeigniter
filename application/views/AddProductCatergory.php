        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="container col-sm-4">
                    <h2 class="text-primary">Category Setup <a href="<?php echo base_url(); ?>super_admin" class="btn btn-primary" style="float:right">Admin Pannel</a></h2>
                    <?php 
                        if($successmsg){
                    ...
                    ?>
                    <form method="POST" style="overflow:scroll; max-height:400px" action="<?php echo base_url();?>super_admin/AddCategory">
